...
export function AudioWaveform({ isRecording, stream }: AudioWaveformProps) {
  ...
  return (
    <div className="flex h-8 flex-1 items-center justify-center gap-[3px] px-2">
      {levels.map((level, index) => (
        <div
          key={index}
          className="rounded-full bg-stone-400 transition-all duration-75 dark:bg-stone-500"
          style={{
            width: "3px",
